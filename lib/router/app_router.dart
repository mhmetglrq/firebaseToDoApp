...
import 'package:flutter_new_projects/features/add_pages/pages/note_page.dart';
...
import '../features/edit_page/page/edit_page.dart';
...
class AppRouter {
  static Route<dynamic>? generate(RouteSettings settings) {
    switch (settings.name) {
      ...
      case AppRouteName.notePage:
        return PageRouteBuilder(
          settings: settings,
          pageBuilder: (animation, __, child) => const NotePage(),
          transitionDuration: const Duration(
            milliseconds: 300,
          ),
          transitionsBuilder: (context, animation, secondaryAnimation, child) {
      ...
      case AppRouteName.editPage:
        final arguments = settings.arguments as Map<String, dynamic>;
        NoteModel noteModel = arguments["noteModel"];
        return PageRouteBuilder(
          settings: settings,
          pageBuilder: (animation, __, child) => EditPage(noteModel: noteModel,),
          transitionDuration: const Duration(
            milliseconds: 300,
          ),
          transitionsBuilder: (context, animation, secondaryAnimation, child) {
